...
class Init1581362731751 {
    constructor() {
        this.name = 'Init1581362731751';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "contact" ("id" SERIAL NOT NULL, "title" character varying(150) NOT NULL, "contact_type_id" integer NOT NULL, CONSTRAINT "REL_744d4eed1aab9a8f3a897ac7a2" UNIQUE ("contact_type_id"), CONSTRAINT "PK_2cbbe00f59ab6b3bb5b8d19f989" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "setting" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "setting_id" integer NOT NULL, CONSTRAINT "REL_f54fc15278f23de594b49f60b7" UNIQUE ("setting_id"), CONSTRAINT "PK_fcb21187dc6094e24a48f677bed" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "first_name" character varying(100) NOT NULL, "last_name" character varying(100), "middle_name" character varying(100), "birth_date" date, "password" character varying NOT NULL, "gender_id" integer, CONSTRAINT "REL_6d4390ab1c0e8c86287d9f4c43" UNIQUE ("gender_id"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`, undefined);
...
exports.Init1581362731751 = Init1581362731751;
//# sourceMappingURL=1581362731751-Init.js.map