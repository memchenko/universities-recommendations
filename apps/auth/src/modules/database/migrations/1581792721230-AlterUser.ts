...
export class AlterUser1581792721230 implements MigrationInterface {
  name = 'AlterUser1581792721230';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "REL_6d4390ab1c0e8c86287d9f4c43"`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "user" DROP COLUMN "gender_id"`,
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "PK_78a916df40e02a9deb1c4b75edb"`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD "gender_id" integer`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "REL_6d4390ab1c0e8c86287d9f4c43" UNIQUE ("gender_id")`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD "first_name" character varying(100) NOT NULL`,
      undefined,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD "id" SERIAL NOT NULL`,
      undefined,
    );
    await queryRunner.query(
